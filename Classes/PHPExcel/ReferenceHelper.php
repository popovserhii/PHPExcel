...
class PHPExcel_ReferenceHelper
{
     ...
     * @param   int             $pNumRows           Number of rows to insert/delete (negative values indicate deletion)
     */
    protected function adjustPageBreaks(PHPExcel_Worksheet $pSheet, $pBefore, $beforeColumnIndex, $pNumCols, $beforeRow, $pNumRows): void
    {
     ...
     */
    public function updateNamedFormulas(PHPExcel $pPhpExcel, $oldName = '', $newName = ''): void
    {
        if ($oldName == '') {
            return;
        }
