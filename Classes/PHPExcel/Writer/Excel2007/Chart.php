...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     */
    private function writeTitle(?PHPExcel_Chart_Title $title, $objWriter): void
    {
        if (null === $title) {
            return;
        }
     ...
     * @param  PHPExcel_Shared_XMLWriter $objWriter XML Writer
     */
    private function writeLegend(?PHPExcel_Chart_Legend $legend, $objWriter): void
    {
        if (null === $legend) {
            return;
        }
     ...
     * @param  PHPExcel_Shared_XMLWriter $objWriter XML Writer
     */
    private function writePlotArea(PHPExcel_Chart_PlotArea $plotArea, ?PHPExcel_Chart_Title $xAxisLabel, ?PHPExcel_Chart_Title $yAxisLabel, $objWriter, PHPExcel_Worksheet $pSheet, PHPExcel_Chart_Axis $xAxis, PHPExcel_Chart_Axis $yAxis, PHPExcel_Chart_GridLines $majorGridlines, PHPExcel_Chart_GridLines $minorGridlines): void
    {
        if (null === $plotArea) {
            return;
        }
     ...
     */
    private function writeDataLabels($objWriter, $chartLayout): void
    {
     ...
     * @param mixed $yAxis
     */
    private function writeCategoryAxis($objWriter, PHPExcel_Chart_PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis): void
    {
     ...
     */
    private function writeValueAxis($objWriter, PHPExcel_Chart_PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines): void
    {
     ...
     */
    private function writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, PHPExcel_Worksheet $pSheet): void
    {
        if (null === $plotGroup) {
            return;
        }
     ...
     */
    private function writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType, PHPExcel_Worksheet $pSheet): void
    {
     ...
     * @param  PHPExcel_Shared_XMLWriter $objWriter XML Writer
     */
    private function writeBubbles($plotSeriesValues, $objWriter, PHPExcel_Worksheet $pSheet): void
    {
        if (null === $plotSeriesValues) {
            return;
        }
     ...
     * @param  PHPExcel_Shared_XMLWriter $objWriter XML Writer
     */
    private function writeLayout(?PHPExcel_Chart_Layout $layout, $objWriter): void
    {
