...
//                        $objWriter->endElement();
     ...
     */
    private function writeVMLHeaderFooterImage(?PHPExcel_Shared_XMLWriter $objWriter = null, $pReference = '', ?PHPExcel_Worksheet_HeaderFooterDrawing $pImage = null): void
    {
        // Calculate object id
